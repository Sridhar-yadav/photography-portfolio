...
SECRET_KEY = env('SECRET_KEY', default='django-insecure-_%x=!6_l3xzx!(=&53_al82l9qx9&$5t!48n+$naa7b(906z5-')
...
DATABASES = {
    'default': dj_database_url.config(
        default=env('DATABASE_URL', default='postgres://postgres:sri630@localhost:5432/photography_db'),
        conn_max_age=600
    )
}
